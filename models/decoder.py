...
class DecoderBlock(nn.Module):
    """
    Decoder Block: Sub-pixel convolution + Concatenation + DSAM
...
class SegmentationHead(nn.Module):
    ...
    Uses sub-pixel convolution to upsample to original resolution.
    """
...
class Decoder(nn.Module):
    ...
    def forward(self, features, stem_features=None):
        """
        Args:
